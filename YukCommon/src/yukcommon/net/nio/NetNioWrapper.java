...
public class NetNioWrapper implements NetWrapper{
	String serverUrl = "";
	String contextUrl = "";
	...
	public NetNioWrapper(String serverUrl, String contextUrl){
	...
	@Override
	public void setFile(String localFile) throws FileNotFoundException  {
	...
	@Override
	public void setResponse(HttpResponse response) throws IOException, InterruptedException, ExecutionException {					
